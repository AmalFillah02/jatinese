...
const publicRoutes = require('./routes/public'); // Pastikan ini diimpor
...
// PERBAIKAN: Gunakan Environment Variable untuk Origin
const corsOptions = {
...
app.use('/api/public', publicRoutes); // Pastikan ini ada
